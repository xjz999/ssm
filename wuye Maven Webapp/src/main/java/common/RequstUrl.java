...
//  doPost(s);  
	public static JsonNode doGet(String siteUrl,String pathParams,String headKey,String headValue){  
      final String website = siteUrl;//"http://smsapi.api51.cn";
      final int connectTimeOut = 15000;
      final int readDataTimeOut = 50000;  
      HttpURLConnection httpConn = null;  
      String htmlContent = null;  
//      String requestCookie = null;
      String reqUrl = pathParams;//"/code/?code="+smsCode+"&mobile="+mobile;
      ...
      try{
          ...
          // 2、设置请求头  
          if (!headKey.equals("") && !headValue.equals("")){
        	  httpConn.setRequestProperty(headKey,headValue);
          }
          // 3、连接  
